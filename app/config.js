...
var currentCoin = process.env.BTCEXP_COIN || "ZEO";
...
module.exports = {
	...
	site: {
			...
			dropdowns:[
				{
					title:"Related Sites",
					links:[
						{name: "Zeo Explorer", url:"https://explorer.btc21.org", imgUrl:"/img/logo/zeo.svg"},
		...
		prioritizedToolIdsList: [2, 3, 4, 5, 0, 1],
	},
	...
	/* 2 */		{name:"Blocks", url:"/blocks", desc:"Browse all blocks in the blockchain.", fontawesome:"fas fa-cubes"},
	/* 3 */		{name:"Transactions", url:"/tx-stats", desc:"See graphs of total transaction volume and transaction rates.", fontawesome:"fas fa-chart-bar"},

	/* 4 */		{name:"Mempool", url:"/mempool-summary", desc:"Detailed summary of the current mempool for this node.", fontawesome:"fas fa-receipt"},
	/* 5 */		{name:"Pending Tx", url:"/unconfirmed-tx", desc:"Browse unconfirmed/pending transactions.", fontawesome:"fas fa-unlock"},
